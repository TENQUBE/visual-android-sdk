...
//    }
    ...
    static String getCanceledSpentDate(Calendar smsCalendar, Calendar spentCalendar) {
        ...
        LogUtil.LOGI(ParserService.TAG,"getCanceledSpentDate" + "smsCalendar" +  DateUtil.getStringDateAsYYYYMMddHHmmss(smsCalendar));
        ...
        LogUtil.LOGI(ParserService.TAG,"getCanceledSpentDate" + "diffDay" + diffDay);
        LogUtil.LOGI(ParserService.TAG,"getCanceledSpentDate" + "diffDay" +  DateUtil.getStringDateAsYYYYMMddHHmmss(spentCalendar));

        LogUtil.LOGI(ParserService.TAG,"getCanceledSpentDate" + "diffDay2" + diffDay2);
        LogUtil.LOGI(ParserService.TAG,"getCanceledSpentDate" + "diffDay2" + DateUtil.getStringDateAsYYYYMMddHHmmss(spentCalendar2));
        if(diffDay <= diffDay2) {
